...
var _httpsSocksProxy = require('https-socks-proxy');
...
var HandlerForward = function (_HandlerBase) {
    ...
    function HandlerForward(options) {
        ...
        if (options.server.socksMode) {
            _this.socksProxyUrl = options.server.prepareRequestFunction({}).socksProxyUrl;
        }
    ...
    _createClass(HandlerForward, [{
        ...
        value: function run() {
            ...
            if (this.socksProxyUrl) {
                reqOpts.agent = new _httpsSocksProxy.SocksProxyAgent(this.socksProxyUrl);
                if (reqOpts.port == 443) reqOpts.protocol = 'https:';
            }
            this.trgRequest = (reqOpts.port == 443 ? _https2.default : _http2.default).request(reqOpts);
